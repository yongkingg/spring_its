...
if("TRUE" STREQUAL "TRUE")
  set(package_SOURCE_PREFIX /home/autonav/Desktop/yongjun/kalman/src/package)
  set(package_DEVEL_PREFIX /home/autonav/Desktop/yongjun/kalman/devel)
  set(package_INSTALL_PREFIX "")
  set(package_PREFIX ${package_DEVEL_PREFIX})
else()
  set(package_SOURCE_PREFIX "")
  set(package_DEVEL_PREFIX "")
  set(package_INSTALL_PREFIX /home/autonav/Desktop/yongjun/kalman/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'package' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/autonav/Desktop/yongjun/kalman/src/package/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/autonav/Desktop/yongjun/kalman/devel/lib;/home/autonav/Morai_2/devel/lib;/home/autonav/catkin_ws/devel/lib;/opt/ros/noetic/lib)
...
set(package_EXPORTED_TARGETS "package_generate_messages_cpp;package_generate_messages_eus;package_generate_messages_lisp;package_generate_messages_nodejs;package_generate_messages_py")
...
set(depends "roscpp;rospy;std_msgs;message_runtime;morai_msgs;tf2;tf2_ros;tf2_geometry_msgs")
...
set(pkg_cfg_extras "package-msg-extras.cmake")
